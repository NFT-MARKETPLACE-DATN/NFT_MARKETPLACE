...
export const GET_NFT_LISTED_PENDING = 'app/App/GET_NFT_LISTED_PENDING';
export const GET_NFT_LISTED_SUCCESS = 'app/App/GET_NFT_LISTED_SUCCESS';
export const GET_NFT_LISTED_ERROR = 'app/App/GET_NFT_LISTED_ERROR';